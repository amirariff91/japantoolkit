...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://japantoolkit.cepathosting.com/guides/where-to-stay-in-osaka" },
  openGraph: {
    title: "Where to Stay in Osaka: Neighbourhood Guide | Japan Toolkit",
    description:
      "Find the best neighbourhood to stay in Osaka. Namba, Shinsaibashi, Umeda, Shin-Osaka, and Tennoji compared — vibes, prices, and who each area suits.",
    url: "https://japantoolkit.cepathosting.com/guides/where-to-stay-in-osaka",
...
const articleSchema = {
  ...
  mainEntityOfPage: { "@type": "WebPage", "@id": "https://japantoolkit.cepathosting.com/guides/where-to-stay-in-osaka" },
};
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Where to Stay in Osaka", item: "https://japantoolkit.cepathosting.com/guides/where-to-stay-in-osaka" },
  ],
};
